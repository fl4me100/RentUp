...
function seedIfEmpty() {
  ...
  const seeds = [
    ...
    { title: 'Cortador Relva Bosch Elétrico 1800W', category: 'Jardim',      description: 'Corte de 43cm, reservatório de 50L. Cabo de extensão 25m incluído. Ideal para jardins até 800m².', price: 18, region: 'Faro',    photo: 'https://images.unsplash.com/photo-1589923188900-85dae523342b?w=600&auto=format&fit=crop' },
    ...
    { title: 'Stand-Up Paddle Decathlon',           category: 'Desporto',    description: 'Prancha inflável 10\'6", remo ajustável, colete e bomba de ar incluídos. Estado impecável.', price: 30, region: 'Faro',    photo: 'https://images.unsplash.com/photo-1474680096613-71f87ab86f86?w=600&auto=format&fit=crop' },
  ];
