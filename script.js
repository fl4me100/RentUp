...
function seedIfEmpty() {
  ...
  const seeds = [
    ...
    { title: 'Cortador Relva Bosch Elétrico 1800W', category: 'Jardim',      description: 'Corte de 43cm, reservatório de 50L. Cabo de extensão 25m incluído. Ideal para jardins até 800m².', price: 18, region: 'Faro',    photo: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=600&auto=format&fit=crop' },
    ...
    { title: 'Stand-Up Paddle Decathlon',           category: 'Desporto',    description: 'Prancha inflável 10\'6", remo ajustável, colete e bomba de ar incluídos. Estado impecável.', price: 30, region: 'Faro',    photo: 'https://images.unsplash.com/photo-1526948128573-703ee1aeb6fa?w=600&auto=format&fit=crop' },
  ];
